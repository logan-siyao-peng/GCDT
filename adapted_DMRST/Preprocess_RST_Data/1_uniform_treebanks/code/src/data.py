...
class Corpus:
    ...
    def read( self ):
        ...
        for doc in self.documents:
            ...
            if self.mapping not in [None, ""]:
                doc.mapRelation( self.mapping )
...
class Document:
    ...
    def mapRelation( self, mappingRel ):
        ...
        if os.path.isfile( mappingRel ):
            ...
            elif mappingRel == 'gum_classes':
                performMapping(self.tree, gum_classes )
            elif mappingRel == 'gum2rstdt_classes':
                performMapping(self.tree, gum2rstdt_classes)
            elif mappingRel == 'rstdt2gum_classes':
                performMapping(self.tree, rstdt2gum_classes)
            elif mappingRel == 'rstdt_classes':
                performMapping(self.tree, rstdt_classes)
